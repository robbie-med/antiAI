...
- License: **LGPL-3+** — full text in [LGPL-3.txt](LGPL-3.txt)
- Obtained from the Debian `lxde-icon-theme` package.

Files are unmodified 128x128 PNGs, renamed for ordering:

| file | original name |
|---|---|
| 01-folder.png | places/folder.png |
| 02-document.png | mimetypes/x-office-document.png |
| 03-up.png | actions/go-up.png |
| 04-clock.png | apps/clock.png |
| 05-home.png | actions/go-home.png |
| 06-warning.png | status/dialog-warning.png |
