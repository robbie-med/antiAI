...
CMS goes on to ask how these tools have affected the resource costs of primary care practice, and how to develop a comprehensive and consistent approach to payment for technology-enabled care.<sup>[25](#fn25)</sup>
...
Alongside it, the continued push toward FHIR-based digital quality measures.<sup>[26](#fn26)</sup> A digital quality measure is computed from a data stream rather than attested by a human. Right now the stream is the chart.
...
<a name="fn1"></a>1. Hillestad R, Bigelow J, Bower A, Girosi F, Meili R, Scoville R, Taylor R. "Can Electronic Medical Record Systems Transform Health Care? Potential Health Benefits, Savings, and Costs." *Health Affairs* 2005;24(5):1103-17. doi:10.1377/hlthaff.24.5.1103. PMID 16162551.

<a name="fn2"></a>2. RAND Corporation press release, 14SEP2005. https://www.rand.org/news/press/2005/09/14.html

<a name="fn3"></a>3. Himmelstein DU, Woolhandler S. "Hope and Hype: Predicting the Impact of Electronic Medical Records." *Health Affairs* 2005;24(5):1121-23.

<a name="fn4"></a>4. Goodman C. "Savings in Electronic Medical Record Systems? Do It for the Quality." *Health Affairs* 2005;24(5):1124-26.

<a name="fn5"></a>5. HITECH Act, Division B, Title IV of the American Recovery and Reinvestment Act of 2009, Pub. L. 111-5, enacted 17FEB2009.

<a name="fn6"></a>6. CMS, "Medicare and Medicaid EHR Incentive Program Basics" (archived, National Archives web capture).

<a name="fn7"></a>7. Social Security Act §1848(a)(7), 42 U.S.C. §1395w-4(a)(7). https://www.ssa.gov/OP_Home/ssact/title18/1848.htm

<a name="fn8"></a>8. MACRA, Pub. L. 114-10, enacted 16APR2015.

<a name="fn9"></a>9. American Medical Association, "Medicare Basics: Merit-based Incentive Payment System (MIPS)." https://www.ama-assn.org/system/files/medicare-basics-mips.pdf

<a name="fn10"></a>10. American College of Surgeons, 2022 MIPS resource; realized 2024 adjustments −9% to +8.25% under budget neutrality.

<a name="fn11"></a>11. Reporting on Anna Konopka, MD: STAT (27NOV2017), CNN (28NOV2017), Fortune (29NOV2017), NHPR, Medscape, AP. Primary documents: NH Board of Medicine disciplinary file and voluntary surrender agreement; Merrimack County Superior Court order of 15NOV2017.

<a name="fn12"></a>12. Sinsky C, et al. "Allocation of Physician Time in Ambulatory Practice." *Ann Intern Med* 2016;165(11):753-60. doi:10.7326/M16-0961. PMID 27595430.

<a name="fn13"></a>13. Arndt BG, et al. "Tethered to the EHR." *Ann Fam Med* 2017;15(5):419-26.

<a name="fn14"></a>14. Kellermann AL, Jones SS. "What It Will Take To Achieve The As-Yet-Unfulfilled Promises Of Health Information Technology." *Health Affairs* 2013;32(1):63-68. doi:10.1377/hlthaff.2012.0693.

<a name="fn15"></a>15. Schulte F, Fry E. "Death By 1,000 Clicks." KHN / *Fortune*, 18MAR2019. https://kffhealthnews.org/health-industry/death-by-a-thousand-clicks/

<a name="fn16"></a>16. KLAS Research US Acute Care EHR Market Share reports (2025, 2026) as reported by Becker's Hospital Review; Epic revenue figures per Epic spokesperson to Becker's; Oracle-Cerner acquisition, June 2022.

<a name="fn17"></a>17. Peterson Health Technology Institute, "Leading Health Systems: AI-Powered Scribes Alleviate Clinician Burnout; Financial Impact Unclear" (2025); Kim E, Liu VX, Singh K. "AI scribes are not productivity tools (Yet)." *NEJM AI* 2025;2:AIe2501175.

<a name="fn18"></a>18. Aguilar M. "With Ambience's new mega-round, AI scribes have announced nearly $1 billion in funding this year." *STAT News*, 29JUL2025. https://www.statnews.com/2025/07/29/ambience-healthcare-ai-scribe-new-fundraise/

<a name="fn19"></a>19. Dai T, Kvedar JC, Polsky D. "Policy brief: ambient AI scribes and the coding arms race." *npj Digital Medicine* 2025;8:780. doi:10.1038/s41746-025-02272-z. Open access. Underlying sources cited therein: Abridge, "Riverside Health... 11% wRVU Increase"; Microsoft & Northwestern Medicine, DAX Copilot for Epic effectiveness study; Doshi GK, et al., *JCO Oncol Pract* 2024;20:418; Cigna Healthcare reimbursement policy effective 01OCT2025; Jacobs PD, *Health Aff* 2024;43:942-49.

<a name="fn20"></a>20. Trilliant Health / Blue Health Intelligence analysis of national all-payer claims, E/M billing patterns at six large health systems, 2018-2024.

<a name="fn21"></a>21. Holmgren AJ, Fenton CL, Thombley R, Soleimani H, Croci R, DeMasi O, Byron ME, Murray SG, Adler-Milstein JR, Yazdany J. "Ambient Artificial Intelligence Scribes and Physician Financial Productivity." *JAMA Netw Open* 2026;9(1):e2553233. doi:10.1001/jamanetworkopen.2025.53233. PMID 41511775. Cohort study, UCSF, ~1.2 million ambulatory encounters, 1,565 physicians, January 2023 to April 2025; 698 adopters (44.6%). Adopters: +1.81 RVUs/week (5.8%), approximately $3,044 additional annual revenue per physician at 2025 Medicare rates; +0.80 encounters/week (2.8%); no difference in claim denial proportion. Author and institutional statements per UCSF DoC-IT release: the findings are initial evidence that AI scribes change how physicians code and bill, with the open question being whether gains reflect additional services or changed coding practice. Single health system; voluntary early adopters. Cited by CMS in the CY2027 PFS RFI (see ref. 25).

<a name="fn22"></a>22. Invited commentary, "Ambient AI Scribes — What Is the Return on Investment?" *JAMA Netw Open* 2026;9(1):e2553238. doi:10.1001/jamanetworkopen.2025.53238. Subscription fees of $200 to $600 per clinician per month at most health systems; notes incremental gains "could collectively offset subscription fees," and cautions that increased visit volume may expand in-basket workload and erode initial well-being gains.

<a name="fn23"></a>23. CMS, "White House, Tech Leaders Commit to Create Patient-Centric Healthcare Ecosystem"; CMS Health Tech Ecosystem pledge, voluntary, 600+ organizations as of January 2026.

<a name="fn24"></a>24. *Fierce Healthcare*, April 2026, reporting industry comment that CMS will need to include incentives in upcoming fee schedules to drive provider utilization; Bipartisan Policy Center comment on clear, predictable reimbursement pathways.

<a name="fn25"></a>25. CY2027 Medicare Physician Fee Schedule proposed rule, CMS-1848-P, 91 FR 43842, Federal Register document 2026-14327, published 16JUL2026. Quoted passage from RFI section E, "Redesigning Primary Care To Make America Healthy Again," subsection 4.a, "Changes to Primary Care and Care Management Due to Technology and Clinical AI" (FR p. 43936). Comments due 14SEP2026. CMS fact sheet: https://www.cms.gov/newsroom/fact-sheets/calendar-year-cy-2027-medicare-physician-fee-schedule-proposed-rule

<a name="fn26"></a>26. Same rule, Quality Payment Program provisions (FR p. 44143) and digital quality measurement passages.

<a name="fn27"></a>27. Nong P, Neprash HT. "Unintended Consequences of Using Ambient Artificial Intelligence Scribes for Billing." *JAMA Health Forum* 2026;7(1):e255771. doi:10.1001/jamahealthforum.2025.5771. PMID 41511793. Free article; published 02JAN2026, the same day as ref. 21. Quoted remarks from Hannah Neprash, PhD (University of Minnesota School of Public Health), in "Exclusive Interview with the Researcher," NIHCM Foundation, https://nihcm.org/publications/exclusive-interview-with-the-researcher-hannah-neprash-on-ambient-ai-scribes. Analysis supported by the NIHCM Foundation Investigator-Initiated Research Grant Program; Neprash holds a 2026 NIHCM policy research grant titled "The Effect of Ambient AI Scribes on Productivity, Coding Intensity, and Spending." Note the price range given here ($300-500 per user per month) is narrower than the $200-600 range in ref. 22; both are cited as reported.

<a name="fn28"></a>28. Rotenstein LS, Holmgren AJ, Thombley R, et al. "Changes in Clinician Time Expenditure and Visit Quantity With Adoption of Artificial Intelligence-Powered Scribes." *JAMA* 2026. doi:10.1001/jama.2026.2253. PMID 41920565. Five-health-system difference-in-differences analysis; approximately $167 per month in marginal E/M revenue associated with adoption, characterized by the authors as a conservative lower bound.

<a name="fn29"></a>29. Lukac P, et al. "Ambient AI Scribes in Clinical Practice — A Randomized Trial." *NEJM AI* 2025. doi:10.1056/AIoa2501000 (238 physicians, three arms; Nabla −9.5% time-in-note, p=.02; DAX not significant; physicians reported occasional inaccuracies). Elias P, Black KC, Chandak P, et al. "The Moment AI Arrived in the Clinic: Insights from the SAIL 2025 Year in Review." *NEJM AI* 2025;2(11). doi:10.1056/aip2500788 (hallucination risk; mixed productivity findings). Yadav GS, Longhurst CA. "Will AI Make the Electronic Health Record More Efficient for Clinicians?" *NEJM AI* 2025;2(3). doi:10.1056/aie2500020. Atrium Health analysis (112 primary care physicians) found no significant gains in documentation time or productivity. Burnout evidence base is concentrated in voluntary early adopters: Olson KD, Meeker D, Troup M, et al., *JAMA Netw Open* 2025;8(10):e2534976; Shah SJ, Devon-Sand A, Ma SP, et al., *JAMIA* 2025;32(2):375-80.

<a name="fn30"></a>30. Anderson TN, Sinha MS, Cohen IG, Jones RL. "Ambient AI in Clinical Practice — The Legal Landscape of Recording Consent Requirements." *NEJM AI* 2026;3(6). doi:10.1056/AIp2600203.

*Note on ref. 17: the NEJM AI article identifier for Kim, Liu & Singh is printed inconsistently in the secondary source (AIe2501175 in the volume string, AIe2501051 in the DOI). Verify against the journal before print.*
